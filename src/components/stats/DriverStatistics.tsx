    ...
    <div className="w-full h-full flex flex-col min-h-0">
      ...
      <div className="flex-1 min-h-0 px-3 sm:px-4 md:px-6">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-3 sm:p-4 md:p-6 h-full overflow-y-auto">
          <div className="mb-6">
            <div className="font-semibold text-xs sm:text-sm text-gray-800 mb-2 tracking-wide uppercase mb-5">
              Average time per day by category
            </div>
            <div className="grid grid-cols-4 text-xs sm:text-sm font-medium text-gray-700 mb-1">
            ...
            <div
              className="flex w-full rounded-xl shadow-lg overflow-hidden mb-4"
            ...
            >
              ...
              <div
                className="flex-1 flex items-center justify-center bg-blue-500"
                style={{ width: "28.3%" }}
              >
              ...
              <div
                className="flex-1 flex items-center justify-center bg-yellow-400"
                style={{ width: "17.4%" }}
              >
                <span className="font-bold text-white text-xs sm:text-sm">
                  17.4%
            ...
            <div className="flex flex-col divide-y divide-gray-200 text-xs sm:text-sm">
              ...
              <div className="flex items-center py-2">
                <span className="font-medium text-blue-700 flex-1">
                  Unloading
                </span>
                <span className="text-gray-700 w-24 text-right">
                  2 hr 15 min
              ...
              <div className="flex items-center py-2">
                <span className="font-medium text-yellow-700 flex-1">
                  Loading
                </span>
                <span className="text-gray-700 w-24 text-right">
                  1 hr 23 min
